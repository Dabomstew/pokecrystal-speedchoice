...
; ITEM_ZEPHYRBADGE
	item_attribute $0, HELD_NONE, 0, CANT_SELECT, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BICYCLE
...
; ITEM_HIVEBADGE
	item_attribute 0, HELD_NONE, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; X_DEFEND
