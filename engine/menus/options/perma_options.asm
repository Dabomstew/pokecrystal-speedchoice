...
PermaOptionsPresets:
	; Vanilla
	permaoptionspreset Preset_VanillaName, 0, RACEGOAL_RED << RACEGOAL
	; Bingo
	permaoptionspreset Preset_BingoName, ROCKETLESS_VAL | (SPINNERS_NONE << SPINNERS) | BETTER_ENC_SLOTS_VAL | (EXP_FORMULA_BLACKWHITE << EXP_FORMULA), BETTER_MARTS_VAL | EASY_TIN_TOWER_VAL
	; 251
	permaoptionspreset Preset_CEAName, ROCKETLESS_VAL | (SPINNERS_NONE << SPINNERS) | BETTER_ENC_SLOTS_VAL | (EXP_FORMULA_BLACKWHITE << EXP_FORMULA), BETTER_MARTS_VAL | EASY_TIN_TOWER_VAL | (RACEGOAL_RED << RACEGOAL)
	; KIR
	permaoptionspreset Preset_KIRName, (SPINNERS_NONE << SPINNERS) | BETTER_ENC_SLOTS_VAL | (EXP_FORMULA_BLACKWHITE << EXP_FORMULA), BETTER_MARTS_VAL | EVOLVED_EARLY_WILDS_VAL | (RACEGOAL_RED << RACEGOAL)
