...
PermaOptionsPresets:
	...
	; Warp
	permaoptionspreset Preset_KIRName, (SPINNERS_NONE << SPINNERS) | BETTER_ENC_SLOTS_VAL | (EXP_FORMULA_BLACKWHITE << EXP_FORMULA), BETTER_MARTS_VAL | (RACEGOAL_RED << RACEGOAL), DEX_AREA_BEEP_VAL | ROD_ALWAYS_SUCCEEDS_VAL | FAST_EGG_GENERATION_VAL | START_WITH_BIKE_VAL | FAST_EGG_HATCHING_VAL | EASY_CLAIR_BADGE_VAL, EARLY_KANTO_DEX_VAL | NO_HAPPY_EVO_VAL | GUARANTEED_CATCH_VAL | BIKE_INDOORS_VAL | FAST_REPEL_VAL
