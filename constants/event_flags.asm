...
; Unused
	const EVENT_FLOWER_SHOP_ROCKET
	const EVENT_BASEMENT_DIRECTOR
	...
	const EVENT_10E
	const EVENT_10F
	const EVENT_GOT_ROUTE_29_BERRY ; Starting here, these flags are used for berry tree item replacement
	const EVENT_GOT_AZALEA_TOWN_WHT_APRICORN
	const EVENT_GOT_FUCHSIA_CITY_BURNT_BERRY
	const EVENT_GOT_PEWTER_CITY_ICE_BERRY
	const EVENT_GOT_PEWTER_CITY_MINT_BERRY
	const EVENT_GOT_ROUTE_1_BITTER_BERRY
	const EVENT_GOT_ROUTE_11_BERRY
	const EVENT_GOT_ROUTE_2_PSN_CURE_BERRY
	const EVENT_GOT_ROUTE_26_ICE_BERRY
	const EVENT_GOT_ROUTE_30_PSN_CURE_BERRY
	const EVENT_GOT_ROUTE_30_BERRY
	const EVENT_GOT_ROUTE_31_BITTER_BERRY
	const EVENT_GOT_ROUTE_33_PSNCUREBERRY
	const EVENT_GOT_ROUTE_35_MYSTERYBERRY
	const EVENT_GOT_ROUTE_36_ICE_BERRY
	const EVENT_GOT_ROUTE_37_RED_APRICORN
	const EVENT_GOT_ROUTE_37_BLU_APRICORN
	const EVENT_GOT_ROUTE_37_BLK_APRICORN
	const EVENT_GOT_ROUTE_38_BERRY
	const EVENT_GOT_ROUTE_39_MINT_BERRY
	const EVENT_GOT_ROUTE_42_GRN_APRICORN
	const EVENT_GOT_ROUTE_42_PNK_APRICORN
	const EVENT_GOT_ROUTE_42_YLW_APRICORN
	const EVENT_GOT_ROUTE_43_BITTER_BERRY
	const EVENT_GOT_ROUTE_44_BURNT_BERRY
	const EVENT_GOT_ROUTE_45_MYSTERYBERRY
	const EVENT_GOT_ROUTE_46_PRZCUREBERRY
	const EVENT_GOT_ROUTE_46_BERRY
	const EVENT_GOT_VIOLET_CITY_PRZ_CURE_BERRY
	const EVENT_GOT_ROUTE_8_PRZCUREBERRY
	...
	const EVENT_GOT_ZEPHYR_BADGE
	const EVENT_GOT_HIVE_BADGE
	const EVENT_GOT_PLAIN_BADGE
	const EVENT_GOT_FOG_BADGE
	const EVENT_GOT_STORM_BADGE
	const EVENT_GOT_MINERAL_BADGE
	const EVENT_GOT_GLACIER_BADGE
	const EVENT_GOT_RISING_BADGE
	const EVENT_GOT_BOULDER_BADGE
	const EVENT_GOT_CASCADE_BADGE
	const EVENT_GOT_THUNDER_BADGE
	const EVENT_GOT_RAINBOW_BADGE
	const EVENT_GOT_MARSH_BADGE
	const EVENT_GOT_SOUL_BADGE
	const EVENT_GOT_VOLCANO_BADGE
	const EVENT_GOT_EARTH_BADGE
	const EVENT_TEAM_ROCKET_BASE_WHIRLPOOL_BACKUP
	const EVENT_MR_POKEMONS_HOUSE_POKEDEX_BACKUP
	const EVENT_GOT_MYSTERY_EGG
	const EVENT_LAKE_OF_RAGE_RED_SCALE_BACKUP
	const EVENT_RADIO_TOWER_5F_CLEAR_BELL_BACKUP
	const EVENT_GOT_BASEMENT_KEY
	const EVENT_CHERRYGROVE_CITY_MAP_CARD_BACKUP
	const EVENT_ILEX_FOREST_HM_CUT_BACKUP
	const EVENT_RADIO_QUIZ_COMPLETE
	const EVENT_GOT_UNOWN_DEX
	const EVENT_GOT_POKEGEAR
	const EVENT_GOT_AIDE_POTION
	const EVENT_GOT_AIDE_POKE_BALLS
	const EVENT_TRIED_AIDE_POTION
	const EVENT_TRIED_AIDE_POKE_BALLS
	const EVENT_GS_BALL_BACKUP
	const EVENT_GOT_TM27
	const EVENT_GOT_TM21
	const EVENT_GOT_BLUE_CARD
	const EVENT_GOT_EVERYTHING_FROM_BILLS_GRANDPA
	const EVENT_MET_UNDERGROUND_DIRECTOR
	const EVENT_BUENA_ITEM_1
	const EVENT_BUENA_ITEM_2
	const EVENT_BUENA_ITEM_3
	const EVENT_BUENA_ITEM_4
	const EVENT_BUENA_ITEM_5
	const EVENT_BUENA_ITEM_6
	const EVENT_BUENA_ITEM_7
	const EVENT_BUENA_ITEM_8
	const EVENT_BUENA_ITEM_9
	const EVENT_161
	const EVENT_162
	const EVENT_163
	const EVENT_164
